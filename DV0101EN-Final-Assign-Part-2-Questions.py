...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard",style={
                "textAlign": "center",   # centred
                "color":     "#350D36", # hex colour requested
                "fontSize":  "24px"}),#Include style for title
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Year', y='Automobile_Sales', title='Average Automobile Sales Per Year'))
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, names='Vehicle_Type', values='Advertising_Expenses', title='Advertisement Expenditure by Vehicle Type in ' + str(input_year)))
